...
float SHT1x::readHumidity()
{
  ...
  float _linearHumidity = 0;       // Humidity with linear correction applied
  float _correctedHumidity = 0;    // Temperature-corrected humidity
  float _temperature = 0;          // Raw temperature value
